...
if(isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO tb_transaksi_masuk (id_barang, jumlah_msk, username, tgl) VALUES ('$id_brg', '$jumlah', '$users', '$tgl')";
    if(mysqli_query($cn, $sql)) {
        ...
        header("location: ../../../transaksi/masuk.php"); 
    }else{
...
<br>
    <form action="" method="post">
        <h3 class="title">Membuat Data Barang Masuk</h3>
